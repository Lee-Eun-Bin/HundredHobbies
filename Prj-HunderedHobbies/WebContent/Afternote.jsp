      ...
      <p>
       ...
       <%
		...
		try { 
			...
			String query = "SELECT NAME, ID, DAY FROM BOARD";
			rs = stmt.executeQuery(query);
		%>
		  <table align="center" border = "1" cellspacing="0" size="550">
		  <tr>
		...
		<%while(rs.next()) { //rs를 통해 테이블 객체들의 필드값을 넘겨볼 수 있다%>
		  <tr>
		  	<td><a href="Read.jsp?ID=<%=rs.getString("ID")%>"><%=rs.getString("NAME") %></a></td>
		...
		%>
		<p align="right"><input type="button" value="글 쓰기" onClick="location.href='Write.jsp'"></p>
    </article>
    </div>
